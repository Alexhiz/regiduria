...
<body>
    <nav class="navbar navbar-expand-md shadow-sm navbar-light bg-light shadow-sm" >
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">
                <img src="/imagenes/logo1.jpg" width="70px" heigth="60px">REGIDURIA
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @else
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('ubicaciones.index') }}">{{ __('Ubicación') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('unidades.index') }}">{{ __('Unidad') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('regiones.index') }}">{{ __('Región') }}</a>
                        </li>
                        <li class="nav-item">
