            ...
            <div class="row">
                ...
                <div class="form-group d-flex justify-content-center">
                  <div class="col-md-6">
                    ...
                    <input type="text" id="observacion" name="observacion" placeholder="Ingrese la observación" value="{{old('observacion',$band->observacion)}}" class="form-control">       
                  </div>
                  <div class="col-md-6">
                    <label for="num_serie">Número de seríe:</label>
                    <input type="text" id="num_serie" name="num_serie" placeholder="Ingrese la observación" value="{{old('num_serie',$band->num_serie)}}" class="form-control">       
                  </div>
                </div>
              </div>
            </div>
