...
@section('admin')
    <div class="card col-md-12 text-center my-4">
        ...
        <div class="card-body">
          <form id="form-add" action="{{route('oficinas.store')}}" class="form-horizontal" enctype="multipart/form-data" method="POST" >
            @csrf
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="form-group d-flex justify-content-center">
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="text" id="modelo" name="modelo" placeholder="Ingrese el modelo" value="{{old('modelo')}}" class="form-control">       
                  </div>     
                </div>
              </div>
            </div>
